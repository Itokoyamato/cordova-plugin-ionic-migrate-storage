...
#define ORIG_IDB_DIRPATH @"WebKit/IndexedDB"
#define TARGET_IDB_DIRPATH @"WebKit/WebsiteData/IndexedDB"

#define ORIG_IDB_DIRPATH_IOS13 @"WebKit/WebsiteData/IndexedDB/v1"
#define TARGET_IDB_DIRPATH_IOS13 @"WebKit/WebsiteData/IndexedDB/v1"
...
- (BOOL) migrateIndexedDB
{
    ...
    NSString *sourceDirPath = ORIG_IDB_DIRPATH;
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"13.0")) {
        sourceDirPath = ORIG_IDB_DIRPATH_IOS13;
    }

    NSString *targetDirPath = TARGET_IDB_DIRPATH;
    if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"13.0")) {
        targetDirPath = TARGET_IDB_DIRPATH_IOS13;
    }

    NSString *original = [[appLibraryFolder stringByAppendingPathComponent:sourceDirPath] stringByAppendingPathComponent:UI_WEBVIEW_PROTOCOL_DIR];
    NSString *target = [[appLibraryFolder stringByAppendingPathComponent:targetDirPath] stringByAppendingPathComponent:wkWebviewProtocolDir];
